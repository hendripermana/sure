...
module DS
  class Select < ViewComponent::Base
    attr_reader :form, :method, :items, :selected_value, :placeholder,
                :variant, :searchable, :menu_placement, :options
    ...
    def initialize(form:, method:, items:, selected: nil, placeholder: "Select...",
                   variant: :simple, include_blank: nil, searchable: false,
                   menu_placement: :auto, **options)
      @form = form
      @method = method
